 ...
 * @author  creatist
 */
public class vInteger extends ca.mb.armchair.JVPL.VisualiserOfClass {

    private javax.swing.JTextField jTextField;
    private boolean insideUpdate;
    
    /** Creates a new visualiser of Integer */
    public vInteger() {        
        insideUpdate = false;
    }
    ...
    public String getPrimitiveInitialisation() {
        return "new java.lang.Integer(" + jTextField.getText() + ")";
    }
    ...
    protected void populateCustom() {
        ...
        jTextField.addCaretListener(new javax.swing.event.CaretListener() {
            public void caretUpdate(javax.swing.event.CaretEvent evt) {
                insideUpdate = true;
                try {
                    setInstance(new Integer(jTextField.getText()));
