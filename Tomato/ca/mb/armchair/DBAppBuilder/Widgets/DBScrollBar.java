...
/**
 * A DB-aware JScrollBar
 *
 * @author  creatist
 */
public class DBScrollBar extends javax.swing.JScrollBar implements ca.mb.armchair.DBAppBuilder.Interfaces.DBBindableComponent {
 
    private java.util.Vector listeners = new java.util.Vector();

    /** Creates a new instance of DBScrollBar */
    public DBScrollBar() {
